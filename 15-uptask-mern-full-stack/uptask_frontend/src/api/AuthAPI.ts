...
import { CheckPasswordForm, ConfirmToken, ForgotPasswordForm, RequestConfirmationCodeForm, UserLoginForm, UserRegistrationForm, userSchema } from "../types";
...
// Función para revisar que el password sea correcto
